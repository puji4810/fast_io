...
atoi_vs_from_chars (benchmark/0022.from_chars/atoi_vs_from_chars.cc) — 10,000,000 integers


| Method                        | Time         |
| ----------------------------- | ------------ |
| std::atoi                     | 0.213863127s |
| std::from_chars               | 0.086160135s |
| fast_io char_digit_to_literal | 0.060643083s |
| fast_float::from_chars        | 0.083341704s |
